...
if 1:
    ...
    # Use a rectangular mesh with 5 spanwise nodes and 3 chordwise nodes.
    # This means there are 4 spanwise panels and 2 chordwise panels.
    num_x = 3
    num_y = 5
    span = 10.
    chord = 1.
...
# Uncomment these lines according to which variables you would like the
# optimizer to control
